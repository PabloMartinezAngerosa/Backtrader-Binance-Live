...
[docs]    async def before_reconnect(self):
        if self.ws:
...
[docs]class BinanceSocketManager:
...
[docs]    def __init__(self, client: AsyncClient, loop=None, user_timeout=KEEPALIVE_TIMEOUT):
...
[docs]    def depth_socket(self, symbol: str, depth: Optional[str] = None, interval: Optional[int] = None):
...
[docs]    def kline_socket(self, symbol: str, interval=AsyncClient.KLINE_INTERVAL_1MINUTE):
...
[docs]    def kline_futures_socket(self, symbol: str, interval=AsyncClient.KLINE_INTERVAL_1MINUTE,
...
[docs]    def miniticker_socket(self, update_time: int = 1000):
...
[docs]    def trade_socket(self, symbol: str):
...
[docs]    def aggtrade_socket(self, symbol: str):
        """Start a websocket for symbol trade data
...
[docs]    def aggtrade_futures_socket(self, symbol: str, futures_type: FuturesType = FuturesType.USD_M):
...
[docs]    def symbol_miniticker_socket(self, symbol: str):
...
[docs]    def symbol_ticker_socket(self, symbol: str):
...
[docs]    def index_price_socket(self, symbol: str, fast: bool = True):
...
[docs]    def symbol_mark_price_socket(self, symbol: str, fast: bool = True, futures_type: FuturesType = FuturesType.USD_M):
        """Start a websocket for a symbol's futures mark price
...
[docs]    def all_mark_price_socket(self, fast: bool = True, futures_type: FuturesType = FuturesType.USD_M):
...
[docs]    def symbol_ticker_futures_socket(self, symbol: str, futures_type: FuturesType = FuturesType.USD_M):
        """Start a websocket for a symbol's ticker data
        By default all markets are included in an array.
...
[docs]    def individual_symbol_ticker_futures_socket(self, symbol: str, futures_type: FuturesType = FuturesType.USD_M):
...
[docs]    def all_ticker_futures_socket(self, futures_type: FuturesType = FuturesType.USD_M):
        """Start a websocket for all ticker data
        By default all markets are included in an array.
...
[docs]    def symbol_book_ticker_socket(self, symbol: str):
...
[docs]    def book_ticker_socket(self):
...
[docs]    def multiplex_socket(self, streams: List[str]):
...
[docs]    def options_multiplex_socket(self, streams: List[str]):
        """Start a multiplexed socket using a list of socket names.
        User stream sockets can not be included.
...
[docs]    def futures_multiplex_socket(self, streams: List[str], futures_type: FuturesType = FuturesType.USD_M):
        """Start a multiplexed socket using a list of socket names.
        User stream sockets can not be included.
...
[docs]    def futures_depth_socket(self, symbol: str, depth: str = '10', futures_type: FuturesType = FuturesType.USD_M):
...
[docs]    def futures_user_socket(self):
...
[docs]    def coin_futures_socket(self):
...
[docs]    def isolated_margin_socket(self, symbol: str):
...
[docs]    def options_ticker_socket(self, symbol: str):
...
[docs]    def options_recent_trades_socket(self, symbol: str):
...
[docs]    def options_kline_socket(self, symbol: str, interval=AsyncClient.KLINE_INTERVAL_1MINUTE):
...
[docs]    def options_depth_socket(self, symbol: str, depth: str = '10'):
        """Subscribe to a depth data stream
...
[docs]    def start_kline_socket(self, callback: Callable, symbol: str, interval=AsyncClient.KLINE_INTERVAL_1MINUTE) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_kline_futures_socket(self, callback: Callable, symbol: str,
...
[docs]    def start_miniticker_socket(self, callback: Callable, update_time: int = 1000) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_trade_socket(self, callback: Callable, symbol: str) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_aggtrade_socket(self, callback: Callable, symbol: str) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_aggtrade_futures_socket(
...
[docs]    def start_symbol_miniticker_socket(self, callback: Callable, symbol: str) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_symbol_ticker_socket(self, callback: Callable, symbol: str) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_ticker_socket(self, callback: Callable) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_index_price_socket(self, callback: Callable, symbol: str, fast: bool = True) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_symbol_mark_price_socket(
...
[docs]    def start_all_mark_price_socket(
...
[docs]    def start_symbol_ticker_futures_socket(
        self, callback: Callable, symbol: str, futures_type: FuturesType = FuturesType.USD_M
    ) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_individual_symbol_ticker_futures_socket(
        self, callback: Callable, symbol: str, futures_type: FuturesType = FuturesType.USD_M
    ) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_all_ticker_futures_socket(self, callback: Callable, futures_type: FuturesType = FuturesType.USD_M) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_symbol_book_ticker_socket(self, callback: Callable, symbol: str) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_book_ticker_socket(self, callback: Callable) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_multiplex_socket(self, callback: Callable, streams: List[str]) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_options_multiplex_socket(self, callback: Callable, streams: List[str]) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_futures_multiplex_socket(
...
[docs]    def start_user_socket(self, callback: Callable) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_margin_socket(self, callback: Callable) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_futures_socket(self, callback: Callable) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_coin_futures_socket(self, callback: Callable) -> str:
        return self._start_async_socket(
            callback=callback,
...
[docs]    def start_isolated_margin_socket(self, callback: Callable, symbol: str) -> str:
        return self._start_async_socket(
            callback=callback,
