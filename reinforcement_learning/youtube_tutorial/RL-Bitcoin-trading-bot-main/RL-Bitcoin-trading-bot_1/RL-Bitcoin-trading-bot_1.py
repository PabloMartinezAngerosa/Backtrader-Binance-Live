...
class CustomEnv:
    ...
    def __init__(self, df, initial_balance=500, lookback_window_size=20):
        ...
        # State size contains Market+Orders history for the last lookback_window_size steps, 5 params from orders history, 5 params from market history (open-high-low-close-volume)
