...
class SimpleHighToLowMean3V2(StrategyBase):
    ...
    def update_params_fuerza_bruta(self, params):
        #TODO si existio operacion y fue negativa, es mejor que actualice a datos que le dan = 1000 y decidio no ejecutar orden.
        # hay caso q esta actualizacion hace evitar perdidas en velas proximas
        if params["balance"] > 1000 or (self.order_ejecuted_fail == True and params["balance"] >= 1000):
