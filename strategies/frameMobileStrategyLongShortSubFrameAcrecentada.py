...
'''
class FrameMobileStrategyLongShortSubFrameAcrecentada(StrategyBase):
    ...
    def __init__(self, index, parent = None):
        ...
        self.log("Using Long short sub frame acrecentada strategy index " + str(index))
        self.lendata1 = 0
        ...
        self.order = None
        self.len_frames = 0
        self.name = "FrameMobileStrategyLongShortSubFrameAcrecentada" + str(index)
        self.index = index
