...
'''
class SurfingTheRandomWalkScape3(StrategyBase):
    ...
    def __init__(self, index=0, parent = None):
        ...
        self.log("Using Surfing the Random Walk Scape 3 (short edition) ")
        self.lendata1 = 0
        ...
        self.order = None
        self.len_frames = 0
        self.name = "Surfing the Random Walk Scape 3. (Short edition)" 
        self.index = 0
        self.capital_list = []
    ...
    def is_touch_low_media_iterada_3_short(self, actual_price, filter_price):
        ...
        if actual_price <= low_media_3 + self.RMSE_low*4:
                ...
                if self.is_order_long == True:
                    ...
                    if self.long_ticks_order > 0:
                        ...
                        if low <= self.long_profit and continue_limit == True:
                            ...
                            self.capital_acumulado += (self.get_leverage_profit(10, self.long_price, low, martin_gala_capital) - martin_gala_capital)
