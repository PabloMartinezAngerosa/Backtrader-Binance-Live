...
#shouffle dataset. mezcla todo el dataset para que la division posterior sea generalizada en cualquiero momento del modelo
dataset = dataset.sample(frac=1)


numerical_columns = ['price1', 'price2', 'price3','price4','price5', 'price6', 'price7','price8','price9', 'price10','price11','price12','price13', 'price14','price15', 'low_media',
...
#--------------------------
#Trainning simple solution. full node connection
#--------------------------
...
model = Model(numerical_data.shape[1], 2, [400,200,100,50], p=0.4)
print(model)
